...
public class Peripheral extends BluetoothGattCallback {
	...
	public void disconnect() {
		...
		if (gatt != null) {
			try {
				...
				sendConnectionEvent(device, "BlueToothPrinterModuleDisconnectPeripheral");
			} catch (Exception e) {
				sendConnectionEvent(device, "BlueToothPrinterModuleDisconnectPeripheral");
	...
	public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
		...
		if (newState == BluetoothGatt.STATE_CONNECTED) {
			...
			sendConnectionEvent(device, "BlueToothPrinterModuleConnectPeripheral");
	...
	public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
		...
		Log.d(LOG_TAG, "Read: " + BlueToothPrinterModule.bytesToHex(dataValue) + " from peripheral: " + device.getAddress());
		...
		map.putString("value", BlueToothPrinterModule.bytesToHex(dataValue));
		sendEvent("BlueToothPrinterModuleDidUpdateValueForCharacteristic", map);
	}
	...
	public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
		...
		if (readCallback != null) {
			...
			if (status == BluetoothGatt.GATT_SUCCESS) {
				byte[] dataValue = characteristic.getValue();
				String value = BlueToothPrinterModule.bytesToHex(dataValue);
