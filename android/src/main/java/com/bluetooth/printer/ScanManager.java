...
public abstract class ScanManager {
	...
	protected BlueToothPrinterModule blueToothPrinterModule;
	protected AtomicInteger scanSessionId = new AtomicInteger();

	public ScanManager(ReactApplicationContext reactContext, BlueToothPrinterModule blueToothPrinterModule) {
		context = reactContext;
		this.reactContext = reactContext;
		this.blueToothPrinterModule = blueToothPrinterModule;
	}
